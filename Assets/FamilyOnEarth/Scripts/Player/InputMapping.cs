...
//     version 1.7.0
//     from Assets/FamilyOnEarth/Scripts/Player/InputMapping.inputactions
//
...
public partial class @InputMapping: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""SwitchToGravityLess"",
                    ""type"": ""Button"",
                    ""id"": ""c9da4da1-785d-43ce-8c7d-81be15fd185c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""ReturnGravity"",
                    ""type"": ""Button"",
                    ""id"": ""ab51d2aa-f56f-4ebd-b622-e9be82083a32"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c875b28d-c6a4-4ddc-9e5f-8879b151dd4d"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""SwitchToGravityLess"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""26c4c1a7-7772-4972-b0fb-9ba55d43e91c"",
                    ""path"": ""<Keyboard>/h"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ReturnGravity"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
        ...
        m_MovementMap_SwitchToGravityLess = m_MovementMap.FindAction("SwitchToGravityLess", throwIfNotFound: true);
        m_MovementMap_ReturnGravity = m_MovementMap.FindAction("ReturnGravity", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_MovementMap_SwitchToGravityLess;
    private readonly InputAction m_MovementMap_ReturnGravity;
    public struct MovementMapActions
    {
        ...
        public InputAction @SwitchToGravityLess => m_Wrapper.m_MovementMap_SwitchToGravityLess;
        public InputAction @ReturnGravity => m_Wrapper.m_MovementMap_ReturnGravity;
        ...
        public void AddCallbacks(IMovementMapActions instance)
        {
            ...
            @SwitchToGravityLess.started += instance.OnSwitchToGravityLess;
            @SwitchToGravityLess.performed += instance.OnSwitchToGravityLess;
            @SwitchToGravityLess.canceled += instance.OnSwitchToGravityLess;
            @ReturnGravity.started += instance.OnReturnGravity;
            @ReturnGravity.performed += instance.OnReturnGravity;
            @ReturnGravity.canceled += instance.OnReturnGravity;
        }
    ...
    public interface IMovementMapActions
    {
        ...
        void OnSwitchToGravityLess(InputAction.CallbackContext context);
        void OnReturnGravity(InputAction.CallbackContext context);
    }
}
